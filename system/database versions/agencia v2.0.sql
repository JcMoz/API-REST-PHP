...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2020 a las 23:56:56
...
ALTER TABLE `asosoria`
  ...
  ADD KEY `fk_asosoria_formulario_migratorio1_idx` (`id_formulario`);
...
ALTER TABLE `foto`
  ...
  ADD KEY `fk_foto_sitio_turistico1_idx` (`id_sitio_turistico`);
...
--
ALTER TABLE `asosoria`
  ADD CONSTRAINT `fk_asosoria_formulario_migratorio1` FOREIGN KEY (`id_formulario`) REFERENCES `formulario_migratorio` (`id_formulario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `foto`
  ADD CONSTRAINT `fk_foto_sitio_turistico1` FOREIGN KEY (`id_sitio_turistico`) REFERENCES `sitio_turistico` (`id_sitio_turistico`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `pregunta`
  ADD CONSTRAINT `pregunta_ibfk_1` FOREIGN KEY (`id_categoria`) REFERENCES `categoria_pregunta` (`id_categoria`);
